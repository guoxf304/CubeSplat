...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.projmatrix_raw,     # [4, 4]
            raster_settings.tanfovx,
            raster_settings.tanfovy,
            raster_settings.image_height,       # H
            raster_settings.image_width,        # W
            sh,
            raster_settings.sh_degree,
            raster_settings.campos,             # [3,]
    ...
    def backward(ctx, grad_out_color, grad_out_radii, grad_out_depth, grad_out_opacity, grad_n_touched):
        ...
        # colors_precomp、cov3Ds_precomp 为空
        colors_precomp, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer = ctx.saved_tensors

        # Restructure args as C++ method expects them
        args = (raster_settings.bg,                 # [3]
                means3D,                            # [P, 3]
                radii,                              # [P,]
                colors_precomp,                     # none
                scales,                             # [P, 3]
                ...
                raster_settings.tanfovx,
                raster_settings.tanfovy,
                grad_out_color,                     # [3, W, H]
                grad_out_depth,                     # [1, W, H]
                sh,
                raster_settings.sh_degree,
                raster_settings.campos,             # [3,]
                geomBuffer,
        ...
        Ad_R = torch.eye(6, device="cuda")
        Ad_R[:3, :3] = raster_settings.rel_R
        Ad_R[3:, 3:] = raster_settings.rel_R
        grad_tau = torch.sum(grad_tau.view(-1, 6), dim=0)
        grad_tau = grad_tau @ Ad_R
